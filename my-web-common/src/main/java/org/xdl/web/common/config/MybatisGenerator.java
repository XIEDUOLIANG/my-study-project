...
public class MybatisGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test?serverTimezone=GMT&characterEncoding=UTF-8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword(".xdl9257xdl.");
        ...
        pc.setParent("org.xdl.web.common");
        ...
        strategy.setInclude("employee");//对那一张表生成代码
